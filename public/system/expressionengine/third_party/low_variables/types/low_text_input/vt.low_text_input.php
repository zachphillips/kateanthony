...
class Low_text_input extends Low_variables_type {
	...
	function display_settings($var_id, $var_settings)
	{
		...
		$r[] = array(
			$this->setting_label($this->EE->lang->line('variable_maxlength')),
			form_input(array(
		...
		$r[] = array(
			$this->setting_label($this->EE->lang->line('variable_size')),
			form_dropdown($this->input_name('size'), array(
				'large' => $this->EE->lang->line('large'),
				'medium' => $this->EE->lang->line('medium'),
				'small' => $this->EE->lang->line('small'),
				'x-small' => $this->EE->lang->line('x-small')
			), $size)
		);

		$r[] = array(
			$this->setting_label($this->EE->lang->line('variable_pattern'), $this->EE->lang->line('variable_pattern_help')),
			form_input(array(
